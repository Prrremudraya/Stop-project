...
public class OrderScooterTest {
    ...
    @Test
    public void orderingScooterWithButtonHead() throws InterruptedException {
        // дописано для того, чтобы увеличить размер открываемого окна браузера
        driver = new FirefoxDriver(new FirefoxOptions().addArguments("--width=2560").addArguments("--height=1440"));
